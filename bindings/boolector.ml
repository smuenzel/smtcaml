...
(*$
  let () =
    ...
    emit_api ()
      ~modify
  *)
external reset_time : btor -> unit = "caml____boolector_reset_time" [@@ocaml.noalloc]
external reset_stats : btor -> unit = "caml____boolector_reset_stats" [@@ocaml.noalloc]
external print_stats : btor -> unit = "caml____boolector_print_stats" [@@ocaml.noalloc]
external push : btor -> uint32_t -> unit = "caml____boolector_push" [@@ocaml.noalloc]
external pop : btor -> uint32_t -> unit = "caml____boolector_pop" [@@ocaml.noalloc]
external assert_ : node -> unit = "caml____boolector_assert" [@@ocaml.noalloc]
external assume : node -> unit = "caml____boolector_assume" [@@ocaml.noalloc]
external failed : node -> bool = "caml____boolector_failed" [@@ocaml.noalloc]
external get_failed_assumptions : btor -> node array = "caml____boolector_get_failed_assumptions"
external fixate_assumptions : btor -> unit = "caml____boolector_fixate_assumptions" [@@ocaml.noalloc]
external reset_assumptions : btor -> unit = "caml____boolector_reset_assumptions" [@@ocaml.noalloc]
external simplify : btor -> int32_t = "caml____boolector_simplify" [@@ocaml.noalloc]
external set_sat_solver : btor -> string -> unit = "caml____boolector_set_sat_solver" [@@ocaml.noalloc]
external set_opt : btor -> btor_option -> uint32_t -> unit = "caml____boolector_set_opt" [@@ocaml.noalloc]
external get_opt : btor -> btor_option -> uint32_t = "caml____boolector_get_opt" [@@ocaml.noalloc]
external get_opt_min : btor -> btor_option -> uint32_t = "caml____boolector_get_opt_min" [@@ocaml.noalloc]
external get_opt_max : btor -> btor_option -> uint32_t = "caml____boolector_get_opt_max" [@@ocaml.noalloc]
external get_opt_dflt : btor -> btor_option -> uint32_t = "caml____boolector_get_opt_dflt" [@@ocaml.noalloc]
...
external has_opt : btor -> btor_option -> bool = "caml____boolector_has_opt" [@@ocaml.noalloc]
external first_opt : btor -> btor_option = "caml____boolector_first_opt" [@@ocaml.noalloc]
external next_opt : btor -> btor_option -> btor_option = "caml____boolector_next_opt" [@@ocaml.noalloc]
...
external is_bv_const_zero : node -> bool = "caml____boolector_is_bv_const_zero" [@@ocaml.noalloc]
external is_bv_const_one : node -> bool = "caml____boolector_is_bv_const_one" [@@ocaml.noalloc]
external is_bv_const_ones : node -> bool = "caml____boolector_is_bv_const_ones" [@@ocaml.noalloc]
external is_bv_const_max_signed : node -> bool = "caml____boolector_is_bv_const_max_signed" [@@ocaml.noalloc]
external is_bv_const_min_signed : node -> bool = "caml____boolector_is_bv_const_min_signed" [@@ocaml.noalloc]
...
external get_node_id : node -> int32_t = "caml____boolector_get_node_id" [@@ocaml.noalloc]
...
external set_symbol : node -> string -> unit = "caml____boolector_set_symbol" [@@ocaml.noalloc]
external get_width : node -> uint32_t = "caml____boolector_get_width" [@@ocaml.noalloc]
external get_index_width : node -> uint32_t = "caml____boolector_get_index_width" [@@ocaml.noalloc]
external get_fun_arity : node -> uint32_t = "caml____boolector_get_fun_arity" [@@ocaml.noalloc]
external is_const : node -> bool = "caml____boolector_is_const" [@@ocaml.noalloc]
external is_var : node -> bool = "caml____boolector_is_var" [@@ocaml.noalloc]
external is_array : node -> bool = "caml____boolector_is_array" [@@ocaml.noalloc]
external is_array_var : node -> bool = "caml____boolector_is_array_var" [@@ocaml.noalloc]
external is_param : node -> bool = "caml____boolector_is_param" [@@ocaml.noalloc]
external is_bound_param : node -> bool = "caml____boolector_is_bound_param" [@@ocaml.noalloc]
external is_uf : node -> bool = "caml____boolector_is_uf" [@@ocaml.noalloc]
external is_fun : node -> bool = "caml____boolector_is_fun" [@@ocaml.noalloc]
...
external is_equal_sort : node -> node -> bool = "caml____boolector_is_equal_sort" [@@ocaml.noalloc]
external is_array_sort : sort -> bool = "caml____boolector_is_array_sort" [@@ocaml.noalloc]
external is_bitvec_sort : sort -> bool = "caml____boolector_is_bitvec_sort" [@@ocaml.noalloc]
external is_fun_sort : sort -> bool = "caml____boolector_is_fun_sort" [@@ocaml.noalloc]
external bitvec_sort_get_width : sort -> uint32_t = "caml____boolector_bitvec_sort_get_width" [@@ocaml.noalloc]
...
external satR : btor -> btorResult = "caml____boolector_satR" [@@ocaml.noalloc]
external limited_satR : btor -> int32_t -> int32_t -> btorResult = "caml____boolector_limited_satR" [@@ocaml.noalloc]
external bv_assignment : node -> string = "caml_boolector_bv_assignment"
external uf_assignment_vector : node -> ((string*string) array) = "caml____boolector_uf_assignment_vector"
