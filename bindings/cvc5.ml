...
external sort__getDatatypeConstructorArity : (* class Sort *) sort -> uint64_t = "caml_cvc5__Sort__getDatatypeConstructorArity"
...
external sort__getFunctionArity : (* class Sort *) sort -> uint64_t = "caml_cvc5__Sort__getFunctionArity"
...
external sort__getUninterpretedSortConstructorArity : (* class Sort *) sort -> uint64_t = "caml_cvc5__Sort__getUninterpretedSortConstructorArity"
...
external sort__getDatatypeArity : (* class Sort *) sort -> uint64_t = "caml_cvc5__Sort__getDatatypeArity"
external sort__getTupleLength : (* class Sort *) sort -> uint64_t = "caml_cvc5__Sort__getTupleLength"
