...
external solver__assertFormula : (* class Solver *) term -> unit = "caml_cvc5__Solver__assertFormula" [@@ocaml.noalloc]
...
external solver__setOption : (* class Solver *) solver -> string -> string -> unit = "caml_cvc5__Solver__setOption" [@@ocaml.noalloc]
...
external sort__getKind : (* class Sort *) sort -> sortKind = "caml_cvc5__Sort__getKind" [@@ocaml.noalloc]
external sort__hasSymbol : (* class Sort *) sort -> bool = "caml_cvc5__Sort__hasSymbol" [@@ocaml.noalloc]
external sort__getSymbol : (* class Sort *) sort -> string = "caml_cvc5__Sort__getSymbol"
external sort__isNull : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isNull" [@@ocaml.noalloc]
external sort__isBoolean : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isBoolean" [@@ocaml.noalloc]
external sort__isInteger : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isInteger" [@@ocaml.noalloc]
external sort__isReal : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isReal" [@@ocaml.noalloc]
external sort__isRegExp : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isRegExp" [@@ocaml.noalloc]
external sort__isRoundingMode : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isRoundingMode" [@@ocaml.noalloc]
external sort__isBitVector : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isBitVector" [@@ocaml.noalloc]
external sort__isFloatingPoint : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isFloatingPoint" [@@ocaml.noalloc]
external sort__isDatatype : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isDatatype" [@@ocaml.noalloc]
external sort__isDatatypeConstructor : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isDatatypeConstructor" [@@ocaml.noalloc]
external sort__isDatatypeSelector : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isDatatypeSelector" [@@ocaml.noalloc]
external sort__isDatatypeUpdater : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isDatatypeUpdater" [@@ocaml.noalloc]
external sort__isFunction : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isFunction" [@@ocaml.noalloc]
external sort__isPredicate : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isPredicate" [@@ocaml.noalloc]
external sort__isTuple : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isTuple" [@@ocaml.noalloc]
external sort__isRecord : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isRecord" [@@ocaml.noalloc]
external sort__isArray : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isArray" [@@ocaml.noalloc]
external sort__isFiniteField : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isFiniteField" [@@ocaml.noalloc]
external sort__isSet : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isSet" [@@ocaml.noalloc]
external sort__isBag : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isBag" [@@ocaml.noalloc]
external sort__isSequence : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isSequence" [@@ocaml.noalloc]
external sort__isAbstract : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isAbstract" [@@ocaml.noalloc]
external sort__isUninterpretedSort : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isUninterpretedSort" [@@ocaml.noalloc]
external sort__isUninterpretedSortConstructor : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isUninterpretedSortConstructor" [@@ocaml.noalloc]
...
external sort__isInstantiated : (* class Sort *) sort -> bool = "caml_cvc5__Sort__isInstantiated" [@@ocaml.noalloc]
...
external sort__getAbstractedKind : (* class Sort *) sort -> sortKind = "caml_cvc5__Sort__getAbstractedKind" [@@ocaml.noalloc]
...
external sort__getBitVectorSize : (* class Sort *) sort -> uint32_t = "caml_cvc5__Sort__getBitVectorSize" [@@ocaml.noalloc]
external sort__getFiniteFieldSize : (* class Sort *) sort -> string = "caml_cvc5__Sort__getFiniteFieldSize"
external sort__getFloatingPointExponentSize : (* class Sort *) sort -> uint32_t = "caml_cvc5__Sort__getFloatingPointExponentSize" [@@ocaml.noalloc]
external sort__getFloatingPointSignificandSize : (* class Sort *) sort -> uint32_t = "caml_cvc5__Sort__getFloatingPointSignificandSize" [@@ocaml.noalloc]
...
external result__isNull : (* class Result *) sat_result -> bool = "caml_cvc5__Result__isNull" [@@ocaml.noalloc]
external result__isSat : (* class Result *) sat_result -> bool = "caml_cvc5__Result__isSat" [@@ocaml.noalloc]
external result__isUnsat : (* class Result *) sat_result -> bool = "caml_cvc5__Result__isUnsat" [@@ocaml.noalloc]
external result__isUnknown : (* class Result *) sat_result -> bool = "caml_cvc5__Result__isUnknown" [@@ocaml.noalloc]
external result__toString : (* class Result *) sat_result -> string = "caml_cvc5__Result__toString"
external result__getUnknownExplanation : (* class Result *) sat_result -> unknownExplanation = "caml_cvc5__Result__getUnknownExplanation" [@@ocaml.noalloc]
...
external term__operator_equal : (* class Term *) term -> term -> bool = "caml_cvc5__Term__operator_equal" [@@ocaml.noalloc]
external term__getId : (* class Term *) term -> int64 = "caml_cvc5__Term__getId"
external term__getKind : (* class Term *) term -> kind = "caml_cvc5__Term__getKind" [@@ocaml.noalloc]
...
external term__hasOp : (* class Term *) term -> bool = "caml_cvc5__Term__hasOp" [@@ocaml.noalloc]
external term__getOp : (* class Term *) term -> op = "caml_cvc5__Term__getOp"
external term__hasSymbol : (* class Term *) term -> bool = "caml_cvc5__Term__hasSymbol" [@@ocaml.noalloc]
external term__getSymbol : (* class Term *) term -> string = "caml_cvc5__Term__getSymbol"
external term__isNull : (* class Term *) term -> bool = "caml_cvc5__Term__isNull" [@@ocaml.noalloc]
...
external term__getRealOrIntegerValueSign : (* class Term *) term -> int32_t = "caml_cvc5__Term__getRealOrIntegerValueSign" [@@ocaml.noalloc]
external term__isInt32Value : (* class Term *) term -> bool = "caml_cvc5__Term__isInt32Value" [@@ocaml.noalloc]
external term__getInt32Value : (* class Term *) term -> int32_t = "caml_cvc5__Term__getInt32Value" [@@ocaml.noalloc]
external term__isUInt32Value : (* class Term *) term -> bool = "caml_cvc5__Term__isUInt32Value" [@@ocaml.noalloc]
external term__getUInt32Value : (* class Term *) term -> uint32_t = "caml_cvc5__Term__getUInt32Value" [@@ocaml.noalloc]
external term__isInt64Value : (* class Term *) term -> bool = "caml_cvc5__Term__isInt64Value" [@@ocaml.noalloc]
external term__getInt64Value : (* class Term *) term -> int64 = "caml_cvc5__Term__getInt64Value"
external term__isUInt64Value : (* class Term *) term -> bool = "caml_cvc5__Term__isUInt64Value" [@@ocaml.noalloc]
external term__getUInt64Value : (* class Term *) term -> int64 = "caml_cvc5__Term__getUInt64Value"
external term__isIntegerValue : (* class Term *) term -> bool = "caml_cvc5__Term__isIntegerValue" [@@ocaml.noalloc]
external term__getIntegerValue : (* class Term *) term -> string = "caml_cvc5__Term__getIntegerValue"
external term__isStringValue : (* class Term *) term -> bool = "caml_cvc5__Term__isStringValue" [@@ocaml.noalloc]
external term__isBooleanValue : (* class Term *) term -> bool = "caml_cvc5__Term__isBooleanValue" [@@ocaml.noalloc]
external term__getBooleanValue : (* class Term *) term -> bool = "caml_cvc5__Term__getBooleanValue" [@@ocaml.noalloc]
external term__isBitVectorValue : (* class Term *) term -> bool = "caml_cvc5__Term__isBitVectorValue" [@@ocaml.noalloc]
...
external op__getKind : (* class Op *) op -> kind = "caml_cvc5__Op__getKind" [@@ocaml.noalloc]
external op__isIndexed : (* class Op *) op -> bool = "caml_cvc5__Op__isIndexed" [@@ocaml.noalloc]
