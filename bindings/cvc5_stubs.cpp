...
#define APIPREFIX cvc5

API0__(new_Solver)

#define APIM0(A,B) APIM0__(A,B)
#define APIM0_BLOCKING(A,B) APIM0_BLOCKING__(A,B)
#define APIM1(A,B) APIM1__(A,B)
#define APIM2(A,B) APIM2__(A,B)
#define APIM3(A,B) APIM3__(A,B)
#define APIM4(A,B) APIM4__(A,B)
#define APIM5(A,B) APIM5__(A,B)
#define APIM1_IMPLIED(A,B) APIM1_IMPLIED__(A,B)
#define APIM2_IMPLIED(A,B) APIM2_IMPLIED__(A,B)
#define APIM1_OVERLOAD(...) APIM1_OVERLOAD_(__VA_ARGS__)
#define APIM1_OVERLOAD_BLOCKING(...) APIM1_OVERLOAD_BLOCKING__(__VA_ARGS__)
#define APIM1_OVERLOAD_IMPLIED(...) APIM1_OVERLOAD_IMPLIED_(__VA_ARGS__)
#define APIM2_OVERLOAD(...) APIM2_OVERLOAD_(__VA_ARGS__)
#define APIM2_OVERLOAD_IMPLIED(...) APIM2_OVERLOAD_IMPLIED_(__VA_ARGS__)
#define APIM3_OVERLOAD(...) APIM3_OVERLOAD_(__VA_ARGS__)
#define APIM4_OVERLOAD(...) APIM4_OVERLOAD_(__VA_ARGS__)
#define APIM5_OVERLOAD(...) APIM5_OVERLOAD_(__VA_ARGS__)
...
APIM5(Solver,defineFun)
APIM5_OVERLOAD(Solver,defineFunRec,symbol,Term,const std::string&,const std::vector<Term>&,const Sort&, const Term&, bool)
APIM4_OVERLOAD(Solver,defineFunRec,term,Term,const Term&,const std::vector<Term>&, const Term&, bool)
//APIM4(Solver,defineFunsRec)
//...
