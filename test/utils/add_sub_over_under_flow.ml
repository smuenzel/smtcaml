  ...
  let run kind =
    ...
    | Satisfiable model ->
      print_s [%message "model"
          (Smt.Model.eval_bitvector t model a : Fast_bitvector.t option)
          (Smt.Model.eval_bitvector t model b : Fast_bitvector.t option)
          ...
          (Smt.Model.eval_bitvector t model diff : Fast_bitvector.t option)
      ]
